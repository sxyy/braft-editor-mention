...
var getContentStateFragment = __webpack_require__(33);
...
var randomizeBlockMapKeys = __webpack_require__(34);
var removeEntitiesAtEdges = __webpack_require__(37);
...
var ContentBlockNode = __webpack_require__(35);
var Immutable = __webpack_require__(13);

var generateRandomKey = __webpack_require__(36);
...
var suggest_SuggestionList =
/*#__PURE__*/
function (_React$Component) {
  inherits_default()(SuggestionList, _React$Component);
  ...
  function SuggestionList() {
    ...
    classCallCheck_default()(this, SuggestionList);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = possibleConstructorReturn_default()(this, (_getPrototypeOf2 = getPrototypeOf_default()(SuggestionList)).call.apply(_getPrototypeOf2, [this].concat(args)));

    defineProperty_default()(assertThisInitialized_default()(_this), "normalizeIndex", function (selectedIndex, max) {
  ...
  createClass_default()(SuggestionList, [{
    ...
    value: function render() {
      ...
      }, array.map(function (person, index) {
        return index === selectedIndex ? React_default.a.createElement("li", {
          style: {
            margin: 0,
            padding: '16px 24px',
            background: '#a7b5bf',
...
// CONCATENATED MODULE: ./suggest/addSuggestion.js


var addSuggestion_addSuggestion = function addSuggestion(_ref) {
  var editorState = _ref.editorState,
      start = _ref.start,
      end = _ref.end,
      trigger = _ref.trigger,
      text = _ref.text;
  var entityKey = external_draft_js_["Entity"].create('MENTION', 'IMMUTABLE', "http://vk.com");
  var currentSelectionState = editorState.getSelection();
  var mentionTextSelection = currentSelectionState.merge({
    anchorOffset: start,
    focusOffset: end
  });
  var insertingContent = external_draft_js_["Modifier"].replaceText(editorState.getCurrentContent(), mentionTextSelection, text, ['link', 'BOLD'], entityKey);
  ...
  if (blockSize === end) {
    insertingContent = external_draft_js_["Modifier"].insertText(insertingContent, insertingContent.getSelectionAfter(), ' ');
  }

  var newEditorState = external_draft_js_["EditorState"].push(editorState, insertingContent, 'insert-mention');
  return external_draft_js_["EditorState"].forceSelection(newEditorState, insertingContent.getSelectionAfter());
};

/* harmony default export */ var suggest_addSuggestion = (addSuggestion_addSuggestion);
...
var handlers_returnHandlers = function returnHandlers(event, editorState, editor) {
  ...
  var autocompleteState = editor.getAutocompleteState(editorState, false);
...
var Switch_style = __webpack_require__(49);
...
var Video_style = __webpack_require__(50);
...
var PlayerModal_style = __webpack_require__(52);
...
var Audio_style = __webpack_require__(53);
...
var Embed_style = __webpack_require__(54);
...
var HorizontalLine_style = __webpack_require__(55);
...
var ControlBar_style = __webpack_require__(56);

// EXTERNAL MODULE: ./components/business/LinkEditor/style.scss
var LinkEditor_style = __webpack_require__(57);

// EXTERNAL MODULE: ./components/common/DropDown/style.scss
var DropDown_style = __webpack_require__(58);
...
var Headings_style = __webpack_require__(59);
...
var TextColor_style = __webpack_require__(60);

// EXTERNAL MODULE: ./components/common/ColorPicker/style.scss
var ColorPicker_style = __webpack_require__(61);
...
var FontSize_style = __webpack_require__(62);
...
var LineHeight_style = __webpack_require__(63);
...
var FontFamily_style = __webpack_require__(64);
...
var EmojiPicker_style = __webpack_require__(65);
...
var LetterSpacing_style = __webpack_require__(66);
...
function (_React$Component) {
  ...
  function BraftEditor(props) {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "hasEntityAtSelection", function (editorState) {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "getAutocompleteRange", function (editorState, trigger) {
      ...
      if (_this.hasEntityAtSelection(editorState)) {
        return null;
      }
      ...
      var index = text.lastIndexOf(trigger);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "getAutocompleteState", function (editorState) {
      var invalidate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      if (!invalidate) {
        return _this.autocompleteState;
      }

      var type = null;
      var trigger = null; // const tagRange = this.getAutocompleteRange(editorState, '#');

      var personRange = _this.getAutocompleteRange(editorState, '@');

      if (!personRange) {
        _this.autocompleteState = null;
        return null;
      }
      ...
      var mentionText = range.text.substring(1, range.text.length);

      _this.editorProps.onMentionChange(mentionText);

      var tempRange = window.getSelection().getRangeAt(0).cloneRange();
      tempRange.setStart(tempRange.startContainer, range.start); // const mark = document.createElement('mark');
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onChange", function (editorState, callback) {
      ...
      window.requestAnimationFrame(function () {
        _this.setState({
          autocompleteState: _this.getAutocompleteState(editorState)
        });
      });
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "getFilteredArray", function (type, text) {
      var dataArray = ['Bruce Wayne', 'Helga Pataki', 'Lady Gaga', 'Lana Del Rey', 'Marilyn Monroe'];
      return dataArray;
    });
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onInsert", function (insertState) {
      if (!_this.props.mentions) {
        return null;
      }

      var index = _this.normalizeIndex(insertState.selectedIndex, _this.props.mentions.length);

      if (isNaN(index)) {
        insertState.text = insertState.text_temp;
      } else {
        insertState.text = insertState.trigger + _this.props.mentions[index];
      }

      return suggest_addSuggestion(insertState);
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "onMentionSelect", function () {
      var autocompleteState = _this.getAutocompleteState(_this.state.editorState, false);

      var insertState = _this.getInsertState(autocompleteState.selectedIndex, autocompleteState.trigger);

      var newEditorState = _this.onInsert(insertState);

      _this.props.onChange(newEditorState); // this.onChange(newEditorState);

    });

    defineProperty_default()(assertThisInitialized_default()(_this), "commitSelection", function (e) {
      var autocompleteState = _this.getAutocompleteState(_this.state.editorState, false);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onArrow", function (e, originalHandler, nudgeAmount) {
      var autocompleteState = _this.getAutocompleteState(_this.state.editorState, false);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onUpArrow", function (e) {
      _this.onArrow(e, _this.editorProps.onUpArrow, -1);
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "onDownArrow", function (e) {
      _this.onArrow(e, _this.editorProps.onDownArrow, 1);
    });
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "handleReturn", function (event, editorState) {
      handlers_returnHandlers(event, editorState, assertThisInitialized_default()(_this));
    });
  ...
  createClass_default()(BraftEditor, [{
    ...
    key: "getInsertState",
    value: function getInsertState(selectedIndex, trigger) {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, this.renderAutocomplete(), external_react_default.a.createElement("div", {
        id: "editor",
        style: style,
